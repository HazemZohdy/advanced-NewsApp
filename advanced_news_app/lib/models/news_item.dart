...
List<NewsItemModel> news = [
  NewsItemModel(
      id: 1,
      title: 'this is the good news',
      imgUrl:
          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQjc5DzEVspRXsj-fZ9PuZWVMiUgUBTxGC8zw&s',
      outher: 'CNN',
      category: 'Sports'),
  NewsItemModel(
      id: 2,
      title: 'this is very good medical',
      imgUrl:
          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRM9Xxa9myf-0lhlx7KUc3VaCZyJBmv6eDB5w&s',
      outher: 'National',
      category: 'soical'),
  NewsItemModel(
      id: 3,
